...
| `VeriRootNavigation` / `VeriNavigationDestination` | Widget / 值类 | `root_navigation.dart` | 四个根页面的中性玻璃导航胶囊；选中滑块可按压/拖动/吸附，圆形快捷记账仅首页显示，支持点击与长按；调用方提供本地化 label，完整约定见 `liquid-glass-navigation.md` |
