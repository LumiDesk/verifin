# 浮动根导航：指针状态机与布局（材质部分已作废）

> **2026-09-10 起：磨砂玻璃、方向高光与导航折射透镜已整体移除。** 本文保留的**指针拖动状态机、胶囊尺寸/位置、窄屏适配与 Shell 约定仍然有效**；所有关于玻璃材质、Shader、高光与素材的描述均为历史记录，不再适用。当前材质规范见 [统一设计规范](../design-system.md)。
